...
**A Godot game for offline Sea of Thieves naval combat.**
...
| Action | Location | Rate | Source | Other actions during it? | Progress retained if cancelled? |
| --- | --- | --- | --- | --- | --- |
| Turn wheel | Upper deck | (From center to extreme) 3.041s; 118.38º/sec | Testing in-game | No | Left at exact state |
...
| Raise sails | Upper deck | (Avg. from 100% to 0%) 7s; -14.3%/sec | Testing in-game | No | Left at exact state |
| Adjust sails | Upper deck | (From extreme to extreme) 7.5s | Testing in-game | No | Left at exact state |
| Raise mast (when fallen) | Upper deck | 10s; 10%/s (REDO WHILE HOLDING A OR D) | Testing in-game | No | Partially (depletes at ? /second) |
| Drop anchor | Upper deck | (Anchor prompt) 0.5s; (Anchor dropping) 3.6s; -180º/s | Testing in-game | Yes | No |
...
| ~~Harpoon [player, ship, ground, loot]~~ | ~~Main deck~~ | | | ~~No~~ | ~~Complete in 1-shot~~ |
...
| ~~Cook food (= put on stove and wait until done)~~ | ~~Lower deck~~ | | | ~~Yes~~ | ~~Partially, fish has about 10 seconds of being done to have progress saved~~ |
...
- https://godotshaders.com/shader/shooting-cone/ (a few with alterations)
